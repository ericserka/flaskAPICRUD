...
def getAllAlerts():
    ...
    return Response(
        json.dumps(retorno, indent=4, sort_keys=True, default=str),
...
def getAlertById(id):
    try:
        ...
        return Response(
            json.dumps({"message": "Alerta não encontrado!"}),
            mimetype="application/json",
        )
...
def createAlert():
    ...
    db.session.commit()
    return Response(
        json.dumps({"message": "Criado com sucesso!"}), mimetype="application/json"
    )
...
def updateAlert(id):
    ...
    try:
        ...
        db.session.commit()
        return Response(
            json.dumps({"message": "Atualizado com sucesso!"}),
            mimetype="application/json",
        )
    except:
        return Response(
            json.dumps({"message": "Erro ao atualizar!"}), mimetype="application/json"
        )
...
def deleteAlert(id):
    try:
        ...
        db.session.commit()
        return Response(
            json.dumps({"message": "Deletado com sucesso!"}),
            mimetype="application/json",
        )
    except:
        return Response(
            json.dumps({"message": "Erro ao deletar!"}), mimetype="application/json"
        )
